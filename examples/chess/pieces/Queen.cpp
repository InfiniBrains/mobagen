#include "Queen.h"
unordered_set<Point2D> Queen::AttackMoves(WorldState& world, const Point2D& origin) {
...
unordered_set<Point2D> Queen::CoverMoves(WorldState& world, const Point2D& origin) {
  auto piece = world.PieceAtPosition(origin);
  if (piece.Piece() != PieceType::Queen) return {};
