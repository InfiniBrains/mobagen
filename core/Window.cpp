...
Window::Window(std::string title) {
  ...
  sdlWindow = SDL_CreateWindow(title.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, window_flags);
  SDL_Log("SDL CREATED");
  ...
  // - Read 'documentation/FONTS.md' for more instructions and details.
